...
is(
    `$perlcc -O3 --staticxs -o ccode312i -r -e 'require Scalar::Util; eval "require List::Util"; print "ok"'`, "ok",
    "#312 dynamic loading not available in this perl"
);
is(
    `$perlcc -O3 --staticxs -o ccode312i -r -e 'require IO; eval "require List::Util"; print "ok"'`, "ok",
    "#312"
);
