...
TODO: {
    ...
    is(
        `$X $perlcc -O2 -occodei27_o2 -r -e"require LWP::UserAgent;print q(ok);"`, 'ok',
...
is(
    `$X $perlcc $opt -occodei27 -r -e"require LWP::UserAgent;print q(ok);"`, 'ok',
    "require LWP::UserAgent $opt"
);

# With -O3 ditto (includes -fno-warnings)
is(
    `$X $perlcc -O3 -occodei27_o3 -r -e"require LWP::UserAgent;print q(ok);"`, 'ok',
