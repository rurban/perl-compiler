...
my @tests = tests();
my @todo = (15,28,29); # 8,14-16 fail on 5.00505
#  @todo = (15) if !$ITHREADS; # On 5.8-nt only 15 fails
...
@todo = (15,25,28,29) if $] < 5.007;
@todo = (10,12,13,15..20,22,28,29) if $] >= 5.010;
@todo = (10,12,13,15..20,22,28,29) if $] >= 5.011;
