...
#         Perl_Charnames(cp)
# 
# where 'cp' is one of the 109_455 code points in Unicode Version 6.0.0 for
# which the mapping is not to the null string.  Note that this mapping is
# accessible through the Perl core via \N{...} and "use charnames".
# 
# This file is for charnames.pm.  It is the union of the Name,
# Unicode_1_Name, Named_Sequence, and Name_Alias properties.  Unicode_1_Name
# entries are used only for otherwise nameless code points.  The Name_Alias
# property adds duplicate code point entries with a corrected name.  The
# original (less correct, but still valid) name will be physically last.
# 
