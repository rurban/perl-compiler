...
#         Hangul_Syllable_Type(cp)
#         Hst(cp)
# 
# where 'cp' is one of the 11_529 code points in Unicode Version 6.0.0 for
# which the mapping is not to 'NA'.  Note that these mappings are not
