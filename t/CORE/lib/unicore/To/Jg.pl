...
#         Jg(cp)
# 
# where 'cp' is one of the 230 code points in Unicode Version 6.0.0 for which
# the mapping is not to 'No_Joining_Group'.  Note that these mappings are not
...
0772		Hah
0773	0774	Alef	# [2]
0775	0776	Farsi_Yeh # [2]
0777		Yeh
0778	0779	Waw	# [2]
077A	077B	Burushaski_Yeh_Barree # [2]
077C		Hah
077D	077E	Seen	# [2]
077F		Kaf
END
