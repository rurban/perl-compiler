...
#         Category(cp)
# 
# where 'cp' is one of the 248_965 code points in Unicode Version 6.0.0 for
# which the mapping is not to 'Cn'.  Note that these mappings are not
...
E0020	E007F	Cf	# [96]
E0100	E01EF	Mn	# [240]
F0000	FFFFD	Co	# [65_534]
100000	10FFFD	Co	# [65_534]
END
