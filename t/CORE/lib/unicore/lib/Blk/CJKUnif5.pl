...
# 
# This file returns the 224 code points in Unicode Version 6.0.0 that match
# any of the following regular expression constructs:
# 
#         \p{Block=CJK_Unified_Ideographs_Extension_D}
#         \p{Blk=CJK_Unified_Ideographs_Extension_D}
#         \p{Is_Block=CJK_Unified_Ideographs_Extension_D}
#         \p{Is_Blk=CJK_Unified_Ideographs_Extension_D}
# 
# X       \p{CJK_Unified_Ideographs_Extension_D}
# X       \p{Is_CJK_Unified_Ideographs_Extension_D}
