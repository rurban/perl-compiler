...
# 
# This file returns the 768 code points in Unicode Version 6.0.0 that match
# any of the following regular expression constructs:
# 
#         \p{Block=Miscellaneous_Symbols_And_Pictographs}
#         \p{Blk=Miscellaneous_Symbols_And_Pictographs}
#         \p{Is_Block=Miscellaneous_Symbols_And_Pictographs}
#         \p{Is_Blk=Miscellaneous_Symbols_And_Pictographs}
# 
# X       \p{Miscellaneous_Symbols_And_Pictographs}
# X       \p{Is_Miscellaneous_Symbols_And_Pictographs}
