...
# 
# This file returns the 576 code points in Unicode Version 6.0.0 that match
# any of the following regular expression constructs:
# 
#         \p{Block=Bamum_Supplement}
#         \p{Blk=Bamum_Supplement}
#         \p{Is_Block=Bamum_Supplement}
#         \p{Is_Blk=Bamum_Supplement}
# 
# X       \p{Bamum_Supplement}
# X       \p{Is_Bamum_Supplement}
