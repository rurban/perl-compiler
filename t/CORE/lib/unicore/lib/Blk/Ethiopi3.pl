...
# 
# This file returns the 48 code points in Unicode Version 6.0.0 that match
# any of the following regular expression constructs:
# 
#         \p{Block=Ethiopic_Extended_A}
#         \p{Blk=Ethiopic_Extended_A}
#         \p{Is_Block=Ethiopic_Extended_A}
#         \p{Is_Blk=Ethiopic_Extended_A}
# 
# X       \p{Ethiopic_Extended_A}
# X       \p{Is_Ethiopic_Extended_A}
