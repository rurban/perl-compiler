...
# 
# This file returns the 256 code points in Unicode Version 6.0.0 that match
# any of the following regular expression constructs:
# 
#         \p{Block=Kana_Supplement}
#         \p{Blk=Kana_Supplement}
#         \p{Is_Block=Kana_Supplement}
#         \p{Is_Blk=Kana_Supplement}
# 
# X       \p{Kana_Supplement}
# X       \p{Is_Kana_Supplement}
