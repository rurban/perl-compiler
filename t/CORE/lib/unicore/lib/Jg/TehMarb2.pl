...
# This file returns the single code point in Unicode Version 6.0.0 that
# matches any of the following regular expression constructs:
# 
#         \p{Joining_Group=Teh_Marbuta_Goal}
#         \p{Jg=Hamza_On_Heh_Goal}
#         \p{Is_Joining_Group=Teh_Marbuta_Goal}
